# Generated by Django 4.2.16 on 2024-09-14 09:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Название рецепта: обязательное поле', max_length=128, verbose_name='Название рецепта')),
        ...
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(help_text='Перечень ингридиентов: обязательное поле', through='recipes.RecipeIngredient', to='recipes.ingredient', verbose_name='Перечень ингредиентов'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='tags',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user', 'recipe'), name='user_recipe_cart_pair_unique'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='favorite',
            constraint=models.UniqueConstraint(fields=('user', 'recipe'), name='user_recipe_fav_pair_unique'),
        ),
    ]
